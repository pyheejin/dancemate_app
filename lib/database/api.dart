...
class ApiServices {
  ...
  Future<dynamic> postImageUpload(FormData bodyData) async {
    final accessToken = await getAccessToken();
  ...
  Future<dynamic> putUserDetail(Map<String, dynamic> request) async {
    final accessToken = await getAccessToken();
  ...
  Future<dynamic> getTicketSalesList(int page, int year, int month) async {
    ...
    final resultData =
        jsonDecode(utf8.decode(response.bodyBytes))['result_data']['tickets'];
    return resultData;
  }
  ...
  Future<dynamic> postChatRoom(int userId) async {
    final accessToken = await getAccessToken();
  ...
  Future<dynamic> putChatRoomDetail(int chatRoomId) async {
    final accessToken = await getAccessToken();
